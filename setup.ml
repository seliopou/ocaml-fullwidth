...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1e6c75cc35f6586d73927afe27daa67a) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers =
            ["Spiros Eliopoulos <spiros@inhabitedtype.com>"; "Mark Li"];
          authors =
            ["Spiros Eliopoulos <spiros@inhabitedtype.com>"; "Mark Li"];
          homepage = Some "https://github.com/seliopou/ocaml-fullwidth";
          bugreports = None;
          synopsis =
            "Translation between half-width and full-width latin characters";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("uchar", None)];
                   ...
                   {
                      lib_modules = ["Fullwidth"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "fullwidth";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\209\127+\255\127f\021\194\2163&\192-e\tn";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
